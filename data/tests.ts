...
export const tests: Test[] = [
    ...
    },
    {
        ...
        questions: [
            ...
            { questionText: 'The physical address of a network card is called:', options: ['IP Address', 'MAC Address', 'Subnet Mask', 'Gateway Address'], correctAnswerIndex: 1},
        ]
    },
     {
        id: 'test-auto-1',
        ...
        questions: [
            ...
            { questionText: 'A car\'s battery provides what type of current?', options: ['Alternating Current (AC)', 'Direct Current (DC)', 'Positive Current (PC)', 'Negative Current (NC)'], correctAnswerIndex: 1},
        ]
    },
    {
        id: 'test-masonry-1',
        ...
        subjectId: 'masonry',
        questions: [
            { questionText: 'What is the ideal ratio of cement to sand for general-purpose mortar?', options: ['1:1', '1:3', '3:1', '1:10'], correctAnswerIndex: 1},
            { questionText: 'What does "curing" mean for concrete and mortar?', options: ['The process of drying it out as fast as possible', 'The process of maintaining moisture for proper hydration and strength development', 'The process of mixing the materials', 'The process of smoothing the surface'], correctAnswerIndex: 1},
            { questionText: 'A "stretcher bond" is a brick pattern where all bricks are laid...', options: ['Vertically', 'Lengthwise', 'Widthwise', 'At a 45-degree angle'], correctAnswerIndex: 1},
        ]
    },
    {
        id: 'test-solar-1',
        ...
        questions: [
            { questionText: 'For maximum energy production, in which direction should solar panels be oriented in Rwanda (Southern Hemisphere)?', options: ['East', 'West', 'South', 'North'], correctAnswerIndex: 3},
            { questionText: 'What is the primary purpose of a charge controller in an off-grid solar system?', options: ['To convert DC to AC', 'To prevent the battery from overcharging or over-discharging', 'To clean the solar panels', 'To increase the voltage from the panels'], correctAnswerIndex: 1},
            { questionText: 'Connecting solar panels in "series" increases the total...', options: ['Current (Amps)', 'Voltage (Volts)', 'Wattage (Watts)', 'Resistance (Ohms)'], correctAnswerIndex: 1},
        ]
    },
    {
        ...
        questions: [
            { questionText: 'What is a "benchmark" in surveying?', options: ['A type of surveying equipment', 'The final map produced', 'A point of known elevation used as a reference', 'A property boundary marker'], correctAnswerIndex: 2},
            { questionText: 'Which of the following would be used to measure the difference in elevation between two points?', options: ['A compass', 'A GPS receiver', 'A leveling instrument (level)', 'A measuring tape'], correctAnswerIndex: 2},
            { questionText: 'What does a "topographic map" show?', options: ['Only property boundaries', 'Only roads and buildings', 'The shape and elevation of the land using contour lines', 'Only vegetation types'], correctAnswerIndex: 2},
        ]
    },
    {
        id: 'test-ca-1',
        ...
        questions: [
            { questionText: 'What are the five "mother sauces" of classical French cuisine?', options: ['Ketchup, Mustard, Mayonnaise, BBQ, Hot Sauce', 'Béchamel, Velouté, Espagnole, Hollandaise, and Tomate', 'Pesto, Alfredo, Marinara, Carbonara, Bolognese', 'Soy, Teriyaki, Hoisin, Oyster, Fish Sauce'], correctAnswerIndex: 1},
            { questionText: 'What is the culinary term for cutting food into long, thin strips, like matchsticks?', options: ['Dicing', 'Mincing', 'Julienne', 'Chopping'], correctAnswerIndex: 2},
            { questionText: 'What is a "roux" used for in cooking?', options: ['As a garnish', 'To thicken sauces and soups', 'To add color', 'As a marinade'], correctAnswerIndex: 1},
        ]
    }
];