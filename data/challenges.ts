...
export const allChallenges: DailyChallenge[] = [
    {
        ...
        quiz: {
            ...
            questions: [
                ...
                { id: '', questionText: 'What is the value of x if 2x = 8?', options: ['2', '4', '6', '8'], correctAnswerIndex: 1 },
                { id: '', questionText: 'Which CSS property is used to change the background color?', options: ['color', 'bgcolor', 'background-color', 'background'], correctAnswerIndex: 2 },
                { id: '', questionText: 'How many layers are in the OSI model?', options: ['5', '6', '7', '8'], correctAnswerIndex: 2 },
                { id: '', questionText: 'What is the next prime number after 7?', options: ['8', '9', '10', '11'], correctAnswerIndex: 3 },
            ]
        }
    },
    {
        ...
        quiz: {
            ...
            questions: [
                ...
                { id: '', questionText: 'Which national park in Rwanda is famous for mountain gorillas?', options: ['Akagera National Park', 'Nyungwe Forest National Park', 'Volcanoes National Park', 'Gishwati Mukura National Park'], correctAnswerIndex: 2 },
    ...
    },
    {
        ...
        quiz: {
            ...
            questions: [
                ...
                { id: '', questionText: 'What is the French term for finely chopped vegetables used as a base for stocks?', options: ['Mirepoix', 'Roux', 'Consommé', 'Julienne'], correctAnswerIndex: 0 },
                { id: '', questionText: 'Which tool is used to tighten and loosen pipes?', options: ['Hammer', 'Pipe Wrench', 'Screwdriver', 'Pliers'], correctAnswerIndex: 1 },
